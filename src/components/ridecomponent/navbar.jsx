...
function Navbar() {
  ...
  return (
    <>
      <div className="fixed md:w-full bg-white w-full justify-between pt-6 p-4 z-[9999]">
        <div className="flex font-semibold text-black w-full items-center px-10 md:px-30 justify-between">
            ...
            {!user ? (
              <>
                ...
                <div className="relative">
                  ...
                  {signupDropdown && (
                    <div className="absolute flex flex-col w-50 text-lg -right-20 top-6 mt-2 bg-white shadow-md rounded p-6 space-y-2 z-[9999] border-2 border-black text-black">
                      <Link
                        to="/signupRide"
                      ...
                      >
                        <div>Ride</div>
                        <img src="/car-ride.png" alt="" className="w-4 h-4 mt-1" />
                      </Link>
                      <Link
                        to="/signupDrive"
                        onClick={() => setSignupDropdown(false)}

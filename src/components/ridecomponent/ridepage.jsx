...
function RidePage() {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      {/* Bottom panel */}
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 lg:w-1/2 bg-white/35 backdrop-blur-sm rounded-2xl shadow-lg p-6 z-[9999] ">
        ...
        {/* Buttons */}
        <div className="flex items-left justify-start gap-4 mt-4">
          <button
            className="flex items-center justify-center gap-2 mx-auto sm:mx-0 px-6 py-3 w-40 bg-black rounded-xl hover:bg-gray-800 transition-all duration-300"
            onClick={() => {
              const map = mapInstanceRef.current;
              if (!map) return;
              if (pickupCoord && dropCoord) {
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 mx-auto sm:mx-0 px-6 py-3 w-40 bg-sky-500 rounded-xl hover:bg-sky-600 transition-all duration-300"
          >
            Services Ride
          </button>
        </div>

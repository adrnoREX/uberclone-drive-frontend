...
function Navbar() {
  ...
  return (
    <>
      <div className="flex fixed mb-50 z-20 font-semibold bg-white text-green-500/80 sm:w-full w-103 sm:space-x-[53%] space-x-20 sm:justify-normal justify-between pt-6 p-4">
        <h1 className="text-3xl sm:pl-30  font-bold ">MyRide</h1>
      ...
      {open && (
        <div className="sm:hidden flex flex-col bg-gray-500 text-green-500/80 sm:relative absolute top-16 left-0 w-103 p-4 space-y-4 z-10">

...
function Navbar() {
  ...
  return (
    <>
      <div className="flex fixed mb-50 z-20 font-semibold bg-white text-green-500/80 w-full justify-between pt-6 py-4 px-8 items-center md:px-10 lg:px-20 xl:px-30">
        ...
        <div className="space-x-8 ">
          <div className="sm:flex space-x-8 hidden">
            ...
            {!user ? (
              <>
                <section onClick={() => setShowLogin(true)} className="cursor-pointer">Log in</section>

                <div className="relative">
                  <section onClick={() => setSignupDropdown(!signupDropdown)} className="cursor-pointer">
                    Sign up
                  </section>
                  {signupDropdown && (
                    <div className="absolute flex flex-col w-50 text-lg -right-20 top-6 mt-2 bg-white shadow-md border-2 border-green-500/80 rounded p-6 space-y-2 text-green-500/80">
                      <Link
                        to="/signupRide"
                      ...
                      >
                        <div>Ride</div>
                        <img src="/car-about.png" alt="" className="w-4 h-4 mt-1" />
                      </Link>
                      <Link
                        to="/signupDrive"
                        onClick={() => setSignupDropdown(false)}
      ...
      {open && (
        <div className="sm:hidden flex flex-col bg-gray-500 text-green-500/80 sm:relative absolute top-16 left-0 w-full p-10 space-y-4 z-10">

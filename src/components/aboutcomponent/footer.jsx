...
function Footer() {
  return (
    <>
      ...
      <div className="sm:pt-16 pt-4 sm:pl-60 pl-20 sm:pr-38 pr-20 w-full sm:max-w-screen max-w-xl justify-between flex flex-col text-center bg-green-500/80 text-white">

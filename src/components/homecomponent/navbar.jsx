...
function Navbar() {
  ...
  return (
    <>
      <div className="flex fixed mb-50 z-20 font-semibold bg-white w-full justify-between pt-6 py-4 px-10 md:px-20 lg:px-30">
        <div className="text-3xl cursor-default font-bold text-sky-500">
          MyRide
        </div>
        <div className="space-x-8 cursor-pointer text-sky-400">
          <div className="md:flex pt-2 space-x-8 hidden">
            ...
            {!user ? (
              <>
                ...
                <div className="relative">
                  ...
                  {signupDropdown && (
                    <div className="absolute flex flex-col w-52 text-lg -right-20 top-6 mt-2 bg-white border-2 border-sky-500 shadow-md rounded p-6 space-y-2 text-sky-400">
                      <Link
                        to="/signupRide"
                      ...
                      >
                        <div>Ride</div>
                        <img src="/car.png" alt="" className="w-4 h-4 mt-1" />
                      </Link>
                      <Link
                        to="/signupDrive"
                        onClick={() => setSignupDropdown(false)}
          ...
          <div
            className="md:hidden flex cursor-pointer pt-2"
      ...
      {open && (
        <div className="md:hidden flex flex-col bg-gray-500 text-sky-400 sm:relative absolute top-16 w-full p-4 space-y-4 z-10 px-10">

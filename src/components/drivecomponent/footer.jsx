...
function Footer() {
  return (
    <>
      ...
      <div className="sm:pt-16 pt-4 sm:pl-38 pl-6 sm:pr-38 pr-6 w-full sm:max-w-screen max-w-xl flex flex-col text-center bg-black text-violet-400">
        <h1 className="sm:mb-16 mb-4">MyRide</h1>
        
        <div className="grid sm:grid-cols-4 grid-cols-1 gap-8 sm:space-x-40 sm:justify-normal sm:text-left text-center">
          ...
          <div className="flex flex-col sm:mt-0 mt-2 space-y-4">
        ...
        <hr className="mt-5" />
        <div className="sm:mt-10 mt-5 sm:mb-20 mb-10 text-sm">

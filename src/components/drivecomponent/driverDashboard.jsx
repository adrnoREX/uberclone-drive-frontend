...
const DriverDashboard = () => {
  ...
  // 🔹 Load driver details into form when user data is fetched
  useEffect(() => {
    if (driver) {
      setForm({
  ...
  //   setTimeout(() => setRideStatus("Ride accepted"), 2000);
  //   setTimeout(() => setRideStatus("Ride in progress"), 4000);
  //   setTimeout(() => setRideStatus("Ride completed"), 7000);
  // };

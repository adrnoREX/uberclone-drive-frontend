...
function Navbar() {
  ...
  return (
    <>
      <div className="flex fixed mb-50 z-20 font-semibold bg-black text-violet-400 sm:w-full w-103 sm:space-x-[53%] space-x-20 sm:justify-normal justify-between pt-6 p-4">
        <h1 className="text-3xl sm:pl-30 font-bold text-">MyRide</h1>

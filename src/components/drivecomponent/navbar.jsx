...
function Navbar() {
  ...
  return (
    <>
      <div className="flex fixed mb-50 z-20 font-semibold bg-black text-violet-400 w-full justify-between items-center py-4 px-10 lg:px-40">
            ...
            {!user ? (
              <>
                ...
                <div className="relative">
                  ...
                  {signupDropdown && (
                    <div className="absolute flex flex-col w-50 text-lg -right-20 top-6 mt-2 bg-white shadow-md rounded p-6 space-y-2 border-2 border-violet-500 text-violet-500">
                      <Link
                        to="/signupRide"
                      ...
                      >
                        <div>Ride</div>
                        <img src="/car-drive.png" alt="" className="w-4 h-4 mt-1" />
                      </Link>
                      <Link
                        to="/signupDrive"
                        onClick={() => setSignupDropdown(false)}

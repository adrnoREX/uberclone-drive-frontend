...
function SignupDrive() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      //   toast.error(
      //     "Please fill in Address, City, and Pincode before submitting"
      //   );
      //   return;
      // }
      ...
      // );
      // const coords = await getCoordinates(fullAddress); // [lat, lon] or null
      // const coords = await getCoordinates(formData);
      // console.log("Coordinates fetched:", coords);

      // if (!coords) {
      //   toast.error("Unable to fetch coordinates for this address", {
      //     id: loadingToastId,
      //   });
      //   return;
      // }
      ...
      // payload.append("latitude", String(coords[0]));
      // payload.append("longitude", String(coords[1]));
